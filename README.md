...
RECODE FROM CodeXBotz
Original Repo - https://github.com/CodeXBotz/File-Sharing-Bot
...
### Installation
#### Deploy on Heroku<br>
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Rehansaputradewantoro/fsub_4button)</br>



#### Deploy in your VPS
````bash
git clone https://github.com/Rehansaputradewantoro/fsub_4button
cd fsub_4button
...
## Support   
Join Our [Telegram Group](https://www.telegram.dog/GeezRam) For Support/Assistance And Our [Channel](https://www.telegram.dog/UserbotCh) For Updates.   
